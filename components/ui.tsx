...
export function Button({
  ...
  return (
    <button
      className={cn(
        "inline-flex items-center justify-center whitespace-nowrap font-medium transition-colors disabled:cursor-not-allowed focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)]",
        VAR[variant],
        SIZE[size],
        className,
      )}
...
export function Modal({
  ...
  // Portal su <body>: evita che un antenato con `transform` (es. l'animazione
  // di pagina) "intrappoli" il position:fixed, mostrando il modale a metà.
  return createPortal(
    <div
    ...
    >
      <div
        className={cn(
          "card flex max-h-[calc(100dvh-2rem)] w-full animate-in flex-col p-0",
